...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM15_MspInit 0 */
    ...
    /* TIM15 DMA Init */
    /* TIM15_COM Init */
    hdma_tim15_com.Instance = DMA1_Channel2;
    hdma_tim15_com.Init.Request = DMA_REQUEST_TIM15_COM;
    hdma_tim15_com.Init.Direction = DMA_PERIPH_TO_MEMORY;
    ...
    hdma_tim15_com.Init.MemDataAlignment = DMA_MDATAALIGN_HALFWORD;
    hdma_tim15_com.Init.Mode = DMA_NORMAL;
    hdma_tim15_com.Init.Priority = DMA_PRIORITY_LOW;
    if (HAL_DMA_Init(&hdma_tim15_com) != HAL_OK)
    {
      Error_Handler();
    }

    __HAL_LINKDMA(tim_baseHandle,hdma[TIM_DMA_ID_COMMUTATION],hdma_tim15_com);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PA11     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = PID_CONTROL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF10_TIM4;
    HAL_GPIO_Init(PID_CONTROL_GPIO_Port, &GPIO_InitStruct);
